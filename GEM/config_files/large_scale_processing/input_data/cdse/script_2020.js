...
var start_date = new Date("2020-02-01");
var end_date = new Date("2020-02-03");
var sampled_dates = splitDateIntoEqualIntervals(start_date, end_date, 1, 1000*60*60*24).map(d => withoutTime(d));
// Defaults
...
function updateOutputMetadata(scenes, inputMetadata, outputMetadata) {
    outputMetadata.userData = {
      timestamps: sampled_dates.map(x => x.toISOString())
    }
  }
